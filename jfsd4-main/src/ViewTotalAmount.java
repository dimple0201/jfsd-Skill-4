...
/**
 * Servlet implementation class ViewTotalAmount
 */
@WebServlet("/ViewTotalAmount")
public class ViewTotalAmount extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewTotalAmount() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        {  
	            ...
	            out.println("</table>");
	            out.println("</html></body>"); 
	            ResultSet sum = stmt.executeQuery("select sum(totalAmount) from tickets");
	            while(sum.next()) {
	            	out.println("Total Amount earned is : "+sum.getInt(1));
	            }
	           }  
